...
namespace Sitecore.Support.Forms.Shell.UI.Dialogs
{
  public class MappingTemplate : WizardForm
  {
    ...
    private Dictionary<string, List<string>> GetCollisionFields()
    {
      ...
      {
        Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu menu = control as Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu;
    ...
    private void LoadMapping()
    {
      ...
      foreach (FieldItem item2 in fields)
      {
        ...
        Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu child = new Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu(this.EbTemplate.Value)
        {
          ID = "t_" + str,
    ...
    private void UpdateMapping()
    {
      foreach (System.Web.UI.Control control in this.MappingBorder.Controls)
      {
        if (control is Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu)
        {
          Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu menu = control as Sitecore.Support.Forms.Shell.UI.Controls.TemplateMenu;
